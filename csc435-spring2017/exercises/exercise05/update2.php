...
<html lang="en">
  ...
  <body>
    ...
    <?php
      ...
      $sql = "UPDATE users SET band2 = \"$band2\" WHERE username = \"$username\" AND password = \"$password\"";
      $mysqli->query($sql);

      $sql = "SELECT band1, band3 FROM users WHERE username = \"$username\" AND password = \"$password\"";
